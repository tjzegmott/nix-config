...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tarik Zegmott"
    user-mail-address "tzegmott@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tarikzegmott/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tarikzegmott/bin" "/profile/bin" "/Users/tarikzegmott/.npm-packages/bin" "/Users/tarikzegmott/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
